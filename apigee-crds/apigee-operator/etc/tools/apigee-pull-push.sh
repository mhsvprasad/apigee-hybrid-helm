...
THIRD_PARTY_COMPONENTS=( \
	"apigee-stackdriver-logging-agent:1.10.1" \
	"apigee-prom-prometheus:v2.48.0" \
	"apigee-stackdriver-prometheus-sidecar:0.9.0" \
	"apigee-kube-rbac-proxy:v0.15.0" \
	"apigee-envoy:v1.27.0" \
	"apigee-prometheus-adapter:v0.11.2" \
	"apigee-asm-ingress:1.17.8-asm.4-distroless" \
	"apigee-asm-istiod:1.17.8-asm.4-distroless" \
	"apigee-fluent-bit:2.2.0" \
)
